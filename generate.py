...
if __name__ == "__main__":
    ...
    reconstruct_gen_track_regularised(encoder, decoder, args, specfunc, track_data, dataloader, transform_dict_list, path="generated")
    # randomised_reconstruction_reg(encoder, decoder, args, specfunc, track_data, dataloader, yaml_config, cluster_config, path="randomised")
    # gen_all_cluster_reg(encoder, decoder, args, specfunc, track_data, dataloader, yaml_config, cluster_config, path="randomised")